...
let getcharacters = async () => { const d = await getDataset('characters'); return d == null ? characters : (characters = d) };
let  gettraits = async () => { const d = await getDataset('traits'); return d == null ? traits : (traits = d) };
let getaccessories = async () => { const d = await getDataset('accessories'); return d == null ? accessories : (accessories = d) };
let getwands = async () => { const d = await getDataset('wands'); return d == null ? wands : (wands = d) };
let getwandwoods = async () => { const d = await getDataset('wandwoods'); return d == null ? wandwoods : (wandwoods = d) };
let getwandcores = async () => { const d = await getDataset('wandcores'); return d == null ? wandcores : (wandcores = d) };
let getwandqualities = async () => { const d = await getDataset('wandqualities'); return d == null ? wandqualities : (wandqualities = d) };
let getspells = async () => { const d = await getDataset('spells'); return d == null ? spells : (spells = d) };
let getbooks = async () => { const d = await getDataset('books'); return d == null ? books : (books = d) };
let getschools = async () => { const d = await getDataset('schools'); return d == null ? schools : (schools = d) };
let getproficiencies = async () => { const d = await getDataset('proficiencies'); return d == null ? proficiencies : (proficiencies = d) };
let getpotions = async () => { const d = await getDataset('potions'); return d == null ? potions : (potions = d) };
let getnamedcreatures = async () => { const d = await getDataset('namedcreatures'); return d == null ? namedcreatures : (namedcreatures = d) };
let getitems = async () => { const d = await getDataset('items'); return d == null ? items : (items = d) };
let getitemsinhand = async () => { const d = await getDataset('itemsinhand'); return d == null ? itemsinhand : (itemsinhand = d) };
let getgeneralitems = async () => { const d = await getDataset('generalitems'); return d == null ? generalitems : (generalitems = d) };
let getcreatures = async () => { const d = await getDataset('creatures'); return d == null ? creatures : (creatures = d) };
let getcreatureparts = async () => { const d = await getDataset('creatureparts'); return d == null ? creatureparts : (creatureparts = d) };
let getplants = async () => { const d = await getDataset('plants'); return d == null ? plants : (plants = d) };
let getplantparts = async () => { const d = await getDataset('plantparts'); return d == null ? plantparts : (plantparts = d) };
let getpreparations = async () => { const d = await getDataset('preparations'); return d == null ? preparations : (preparations = d) };
let getfooddrink = async () => { const d = await getDataset('fooddrink'); return d == null ? fooddrink : (fooddrink = d) };
