async function attributestab() {
  ...
  tabcontent.textContent = 'Fetching API Data 1/18...'; await gettraits(true);
  tabcontent.textContent = 'Fetching API Data 2/18...'; await gettraits(true);
  tabcontent.textContent = 'Fetching API Data 3/18...'; await getwands(true);
  tabcontent.textContent = 'Fetching API Data 4/18...'; await getaccessories(true);
  tabcontent.textContent = 'Fetching API Data 5/18...'; await getwandwoods(true);
  tabcontent.textContent = 'Fetching API Data 6/18...'; await getwandcores(true);
  tabcontent.textContent = 'Fetching API Data 7/18...'; await getwandqualities(true);
  tabcontent.textContent = 'Fetching API Data 8/18...'; await getitemsinhand(true);
  tabcontent.textContent = 'Fetching API Data 9/18...'; await getitems(true);
  tabcontent.textContent = 'Fetching API Data 10/18...'; await getgeneralitems(true);
  tabcontent.textContent = 'Fetching API Data 11/18...'; await getcreatures(true);
  tabcontent.textContent = 'Fetching API Data 12/18...'; await getcreatureparts(true);
  tabcontent.textContent = 'Fetching API Data 13/18...'; await getplants(true);
  tabcontent.textContent = 'Fetching API Data 14/18...'; await getplantparts(true);
  tabcontent.textContent = 'Fetching API Data 15/18...'; await getpreparations(true);
  tabcontent.textContent = 'Fetching API Data 16/18...'; await getfooddrink(true);
  tabcontent.textContent = 'Fetching API Data 17/18...'; await getpotions(true);
  tabcontent.textContent = 'Fetching API Data 18/18...'; await getbooks(true);
